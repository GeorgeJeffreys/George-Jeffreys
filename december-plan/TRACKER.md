...
1. Blue Note (Doug): confirms 2–4 boats by level, quote with comps coming; asks whether students do pool beforehand and whether we want their hotel. Draft (revised per George) says no pool, full confined water Wed–Fri, one centre for all, quote at 20/30/40, and asks for rough hotel quotes to compare with our own research. https://mail.google.com/mail/?authuser=emailgeorgej@gmail.com#all?compose=thread-f:1877056969984552569%2Bmsg-a:r5176232160878148501
2. Aldora (Amanda): multi-boat parallel, USD 110 two-tank with HP120s, nitrox USD 11, 1 comp per 10 paid, block deposit with a 15–30 day cut-off. Draft (approved by George, plus one added question) asks for a block quote at 10/15/20 for Sat 12 and Sun 13 (optional Fri 11), AOW for 3–5, night dive, rental, deposit size, and whether Aldora can also take the 10–20 Open Water students so the whole group stays with one centre. https://mail.google.com/mail/?authuser=emailgeorgej@gmail.com#all?compose=thread-f:1877056974532014935%2Bmsg-a:r338627909758662287
3. Sand Dollar (Angelica): 16 Open Water students at a time, USD 350 all-in with gear, wetsuit and DAN training cover, free diver, USD 14 park fee, one day may run at 1 pm, assumes Casa del Mar. Draft (revised per George: no call) confirms PADI and eLearning, asks about a second cohort above 16, whether they can take the 10–20 certified divers alongside, AOW/nitrox/night dive, and deposit terms. https://mail.google.com/mail/?authuser=emailgeorgej@gmail.com#all?compose=thread-f:1877057007822603642%2Bmsg-a:r7473609881302347566
