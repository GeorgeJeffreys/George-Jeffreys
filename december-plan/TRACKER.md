...
- COZUMEL CHOICE, decide by Fri 25 Sep: four centres can each take the whole group and all four have quoted. Comparison and recommendation in cozumel/OPERATOR_COMPARISON.md: keep Blue Note (cheapest, best terms, free AOW/nitrox, Hotel Plaza at USD 70–88 a room) and Sand Dollar (best beginner capacity, Casa del Mar next door) in play, drop Aldora unless both fail, hold Dive Paradise as the one-resort fallback. Three answers still due before choosing (Blue Note instructors and park fees; Sand Dollar Friday boat; Dive Paradise rate window).
