...
| day | action | owner |
|---|---|---|
| Tue 22 | First wave sent: 5 Cozumel, 3 Thanksgiving, 3 Egypt contacts | done |
...
| Blue Note Scuba | operator | info@bluenotescuba.com | approved | sent | 2026-09-22 sent via Gmail, thread 1a0ca55e7f19ae79 | chase 2026-09-24 if no reply | One 42-ft boat; capacity question |
| Sand Dollar Sports | operator (beginner training) | sds@sanddollarsports.com | approved | sent | 2026-09-22 sent via Gmail, thread 1a0ca5674e6c857a | chase 2026-09-24 if no reply | Shore site works in a norther |
| Aldora Divers | operator (certified/advanced) | frontdesk@aldora.com | approved | sent | 2026-09-22 sent via Gmail, thread 1a0ca55f8e267357 | chase 2026-09-24 if no reply | 6 per boat cap |
...
| contact | role | email | send | status | last_action | next_action | notes |
|---|---|---|---|---|---|---|---|
| Paradise Scuba & Snorkeling Center | operator | paradisescubapr@gmail.com | approved | sent | 2026-09-22 sent via Gmail, thread 1a0ca716dc6c7ebd | chase 2026-09-24 if no reply | USD 125 two-tank Wall |
...
| Emperor Divers Port Ghalib | operator (fallback) | info@emperordivers.com (address inferred from an obfuscated snippet; watch for a bounce) | approved | sent | 2026-09-22 sent via Gmail, thread 1a0ca7227f5db287 | chase 2026-09-24 if no reply; if bounced, use emperordivers.com/contact | 20% non-refundable deposit |
