...
inp('park', "Marine park fee per boat day", 15, "USD/day", "ADVERTISED rate; QUOTED 23 Sep: paid on site for boat days only, none on the two training-site days", MONEY)
