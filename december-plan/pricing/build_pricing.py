...
# ---- Cozumel
W.h2('Cozumel, Sun 13 – Sat 19 Dec 2026 (6 nights, confirmed 22 Sep) and 5-night variant')
...
CZ_N7 = W.inp('Nights, 6-night version (Sun 13 – Sat 19)', 6, 'nights', 'dates confirmed 22 Sep')
CZ_N5 = W.inp('Nights, 5-night version', 5, 'nights', 'brief')
CZ_OW = W.inp('PADI Open Water in-water course, gear, wetsuit and DAN training cover incl. (Sand Dollar)', 350, 'USD', 'QUOTED 2026-09-22 (Sand Dollar email); Blue Note advertised 400', MONEY)
...
CZ_2TANK = W.inp('Two-tank boat dive per day, 5-day package basis (Sand Dollar USD 510 / 5); Aldora USD 110 + tax, or 145 incl. tax and park fee', 102, 'USD', 'QUOTED 2026-09-23 (Sand Dollar email: 2-day 215, 3-day 321, 4-day 420, 5-day 510); Aldora QUOTED 2026-09-22/23', MONEY)
CZ_PARK_MXN = W.inp('Marine park fee per boat day (Sand Dollar charges USD 14)', 241, 'MXN', 'QUOTED 2026-09-22 (Sand Dollar: USD 14/boat day, = MXN 241 at 17.23)', '#,##0')
CZ_GEAR = W.inp('Gear rental per day (certified divers)', 20, 'USD', 'QUOTED 2026-09-22 (Aldora USD 20/day); island advertised 25', MONEY)
CZ_REFRESH = W.inp('Refresher / tune-up shore dive on arrival day (Sand Dollar)', 5, 'USD', 'QUOTED 2026-09-23 (Sand Dollar: scuba tune-up USD 5; guided shore dive USD 5 with a package)', MONEY)
CZ_AOW = W.inp('PADI Advanced Open Water incl. eLearning (Blue Note advertised 530; Sand Dollar QUOTED 380 in-water with eLearning done + PADI AOW eLearning bought separately; Aldora QUOTED 749 all-in)', 530, 'USD', 'ADVERTISED (snippet) kept as the conservative figure; Sand Dollar 380 + eLearning QUOTE NEEDED', MONEY)
CZ_NITROX = W.inp('Nitrox fill per tank (Sand Dollar 13, about 20 tanks; Aldora 11)', 13, 'USD', 'QUOTED 2026-09-23 (Sand Dollar) and 2026-09-22 (Aldora)', MONEY)
CZ_NIGHT = W.inp('Night dive from the boat (Sand Dollar; shore version USD 60 incl. light)', 85, 'USD', 'QUOTED 2026-09-23 (Sand Dollar); Aldora 82 air / 94 nitrox', MONEY)
...
CZ_FREE_PER = W.inp('Operator free places: one per N paying (diving only)', 10, 'paying', 'QUOTED 2026-09-22: Aldora 1 comp at 10+ paid; Sand Dollar one free diver')
W.blank()

# ---- Egypt
W.h2('Egypt (Marsa Shagra), Sat 2 – Fri 8 Jan 2027, 6 nights on the ground')
...
EG_N = W.inp('Nights on the ground (Sun 3 – Fri 8; shortened 23 Sep)', 5, 'nights', 'itinerary')
...
EG_DD_CERT = W.inp('Certified dive days (Mon–Thu, Thu morning only)', 4, 'days', 'itinerary')
EG_DD_BEGFUN = W.inp('Beginner dive days after course (Thu morning)', 1, 'days', 'itinerary')
...
TG_WALL = W.inp('Two-tank Wall dive (Paradise Scuba): USD 145 less 15% group discount, plus 11.5% tax; own gear', 137, 'USD', 'QUOTED 2026-09-22 price and discount; tax rate INFERRED (PR IVU), QUOTE NEEDED', MONEY)
TG_DESECHEO = W.inp('Desecheo two-tank incl. USD 20 park fee, own gear (Taino Divers has no boat as of 2026-09-23; Island Style Charters, max 4 divers per charter, is the referral)', 140, 'USD', 'ADVERTISED (snippet, aggregator lead); QUOTE NEEDED', MONEY)
...
TG_BIO = W.inp('Bio bay boat tour (Parguera Eco Tours; Paradise Scuba also offers, price pending)', 45, 'USD', 'ADVERTISED (snippet)', MONEY)
...
W = Writer(ws)
W.h1('Cozumel — Sun 13 – Sat 19 Dec 2026 (6 nights, confirmed 22 Sep) and 5-night variant')
...
W = Writer(ws)
W.h1('Egypt, Marsa Shagra — Sat 2 – Fri 8 Jan 2027 (6 nights on the ground)')
...
W.blank()
W.h2('Cozumel, 6 nights (Sun 13 – Sat 19 Dec)')
...
W.blank()
W.h2('Egypt, Marsa Shagra (Sat 2 – Fri 8 Jan)')
W.row(['', 'Certified', 'Beginner', 'Advanced'], fonts=[None, H2, H2, H2])
